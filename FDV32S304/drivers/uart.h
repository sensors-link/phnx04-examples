...
// ext def
#define UART1_PORT_P14_P15 	    (0)
#define UART1_PORT_P18_P19 	    (1)
#define UART2_PORT_P04_P05 	    (2)
#define UART2_PORT_P06_P07 	    (3)
...
#define UART_EN_TYPE_SM2 	    (1 << 0)
#define UART_EN_TYPE_REN 	    (1 << 1)
#define UART_EN_TYPE_SFD 	    (1 << 2) // start bit detect
